...
INSERT INTO PALESTRA (id_palestra, tema_palestra, data_palestra, hora_inicio, hora_termino, descricao, cpf) VALUES (10, 'Como se tornar um ninja em banco de dados com Fátima Nunes.', TO_DATE('10/01/2018', 'dd/mm/yyyy'), TO_DATE('10:00', 'HH24:MI'), TO_DATE('11:00', 'HH24:MI'), null, '11111111111');
INSERT INTO PALESTRA (id_palestra, tema_palestra, data_palestra, hora_inicio, hora_termino, descricao, cpf) VALUES (11,'Belas Maldições: as preciosas profecias de Jordana Carnicelli (bruxa).',TO_DATE('10/01/2018', 'dd/mm/yyyy'),TO_DATE('11:00', 'HH24:MI'),TO_DATE('12:00', 'HH24:MI'),null,'22222222222');
INSERT INTO PALESTRA (id_palestra, tema_palestra, data_palestra, hora_inicio, hora_termino, descricao, cpf) VALUES (12, 'Cavaleiros dos Horóscopos: fazendo seu próprio mapa astral com Shun de Andrômeda.',TO_DATE('10/01/2018', 'dd/mm/yyyy'),TO_DATE('14:00', 'HH24:MI'),TO_DATE('15:00', 'HH24:MI'),null,'33333333333');
INSERT INTO PALESTRA (id_palestra, tema_palestra, data_palestra, hora_inicio, hora_termino, descricao, cpf) VALUES (13, 'Caso ou compro um playstation 4?',TO_DATE('11/01/2018', 'dd/mm/yyyy'),TO_DATE('10:00', 'HH24:MI'),TO_DATE('11:30', 'HH24:MI'),null,'44444444444');
INSERT INTO PALESTRA (id_palestra, tema_palestra, data_palestra, hora_inicio, hora_termino, descricao, cpf) VALUES (14, 'Subindo escadas enquanto masca chiclete: desenvolvendo habilidades motoras.',TO_DATE('11/01/2018', 'dd/mm/yyyy'),TO_DATE('11:30', 'HH24:MI'),TO_DATE('12:30', 'HH24:MI'),null,'55555555555');
...
INSERT INTO PAINEL (id_painel, tema_painel, data_painel, descricao, aberto_publico) VALUES (10, 'Vacas que Voam: novo lançamento de Paulo Coelho.', TO_DATE('10/01/2018', 'dd/mm/yyyy'), null, 0);
INSERT INTO PAINEL (id_painel, tema_painel, data_painel, descricao, aberto_publico) VALUES (11, 'Do diário ao backup do cérebro.', TO_DATE('10/01/2018', 'dd/mm/yyyy'), null, 0);
INSERT INTO PAINEL (id_painel, tema_painel, data_painel, descricao, aberto_publico) VALUES (12, 'Microtransações: a decadência do mercado de games.', TO_DATE('10/01/2018', 'dd/mm/yyyy'), null, 1);
INSERT INTO PAINEL (id_painel, tema_painel, data_painel, descricao, aberto_publico) VALUES (13, '150 tons de cinza: a relação entre o bestseller e a primeira geração de pokemons.', TO_DATE('11/01/2018', 'dd/mm/yyyy'), null, 1);
INSERT INTO PAINEL (id_painel, tema_painel, data_painel, descricao, aberto_publico) VALUES (14, 'Lucas Neto: a arte de fazer dinheiro sem entregar nada.', TO_DATE('11/01/2018', 'dd/mm/yyyy'), null, 1);
...
INSERT INTO BARRACA (id_barraca, cpf, modelo, marca) VALUES (1, 20202020200, 'Modelo 1', 'Marca 1');
INSERT INTO BARRACA (id_barraca, cpf, modelo, marca) VALUES (2, 66666666666, 'Modelo 1', 'Marca 2');
INSERT INTO BARRACA (id_barraca, cpf, modelo, marca) VALUES (3, 77777777777, "Modelo 2", "Marca 1");
INSERT INTO BARRACA (id_barraca, cpf, modelo, marca) VALUES (4, 20202020201, "Modelo 2", "Marca 2");
INSERT INTO BARRACA (id_barraca, cpf, modelo, marca) VALUES (5, 99999999999, "Modelo 2", "Marca 2");
INSERT INTO BARRACA (id_barraca, cpf, modelo, marca) VALUES (6, 20202020203, "Modelo 1", "Marca 1");
